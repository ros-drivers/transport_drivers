...
#ifndef SERIAL_COMPONENT__SERIAL_COMPONENT_HPP_
#define SERIAL_COMPONENT__SERIAL_COMPONENT_HPP_
...
class SERIAL_DRIVER_PUBLIC SerialComponent
  : public SerialDriverNode<SerialComponent, Packet, std_msgs::msg::Int32>
{
public:
  explicit SerialComponent(const rclcpp::NodeOptions & options);
...
using SerialDriverT = SerialDriverNode<SerialComponent, Packet, std_msgs::msg::Int32>;
}  // namespace serial_component
#endif  // SERIAL_COMPONENT__SERIAL_COMPONENT_HPP_
